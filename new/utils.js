...
const getServerlessComponentFile = (dir) => {
  const ymlFilePath = path.join(dir, 'serverless.component.yml')
  const yamlFilePath = path.join(dir, 'serverless.component.yaml')
  const jsonFilePath = path.join(dir, 'serverless.component.json')
